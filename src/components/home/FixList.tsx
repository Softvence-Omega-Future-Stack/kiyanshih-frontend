...
const steps = [
  {
    ...
    icon: Briefcase,
    bgColor:
      "bg-[#9672FF] shadow-[0_100px_80px_rgba(150,114,255,0.07),0_64.815px_46.852px_rgba(150,114,255,0.05),0_38.519px_25.481px_rgba(150,114,255,0.04),0_20px_13px_rgba(150,114,255,0.04),0_8.148px_6.519px_rgba(150,114,255,0.03),0_1.852px_3.148px_rgba(150,114,255,0.02)] bg-[#9672FF] ",
  },
  {
  ...
  },
  {
    ...
    icon: CheckCircle,
    bgColor:
      "shadow-[0_100px_80px_0_rgba(242,184,236,0.07),0_64.815px_46.852px_0_rgba(242,184,236,0.05),0_38.519px_25.481px_0_rgba(242,184,236,0.04),0_20px_13px_0_rgba(242,184,236,0.04),0_8.148px_6.519px_0_rgba(242,184,236,0.03),0_1.852px_3.148px_0_rgba(242,184,236,0.02)] bg-[#F2B8EC]", // used green for variation
  },
];
      ...
      <section className="py-40 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <LandingTitle className="mb-2">How Fixlist works?</LandingTitle>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-18 ">
            {steps.map((step, index) => (
              <div className="relative bg-amber-1040 ">
                <div
                  key={index}
