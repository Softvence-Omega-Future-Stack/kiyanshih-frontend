      ...
      <div className="flex flex-1 gap-x-4 ">
        ...
        >
          {activeUser ? (
            <>
              {/* Header */}
              <div className="bg-white px-4 py-3 flex items-center rounded-t-[16px] border-b border-stroke border-gray-200">
                <button
              ...
              {/* Company Info */}
              <div className="px-4 py-3  bg-white flex p-2.5 items-end gap-2.5">
              ...
              {/* Input */}
              <div className="bg-white border-t border-gray-200 p-4 border-t-[rgba(217,217,217,0.40)] rounded-b-[16px]">
                <div className="flex items-end gap-2">
                  ...
                  <button className="px-4 py-2.5 rounded-[6px] bg-[#115E59]  text-white hover:bg-teal-700 transition-colors text-sm font-medium whitespace-nowrap mb-1">
                    Create Proposal
                  </button>
                </div>
              </div>
