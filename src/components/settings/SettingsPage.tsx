            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between py-4">
                  ...
                  >
                    <span
                      className={`inline-block h-4 sm:h-4 w-4 sm:w-4 transform rounded-full bg-white transition-transform ${
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      ...
                      <button className="self-start sm:self-auto px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white text-xs sm:text-sm rounded hover:bg-blue-700 transition-colors whitespace-nowrap">
                        Verify now
                      </button>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Date: {payment.date} · {payment.cardNumber}
                        </p>
                      </div>
          ...
          <div className="space-y-6 sm:space-y-8 px-3 sm:px-6 lg:px-8">
            <div>
              ...
              <p className="text-gray-600 text-xs sm:text-sm lg:text-base mb-6 sm:mb-8">
                ...
                customers in app & web, enabling them to make successful
                bookings.
              </p>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
                      <div className="relative">
                        <Clock className="absolute left-2 sm:left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                        <input
                          type="text"
                          ...
                          className="w-full pl-7 sm:pl-9 pr-2 sm:pr-3 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        />
                      </div>
                      <div className="relative">
                        <Clock className="absolute left-2 sm:left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                      ...
                      {Object.entries({
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              toggleDay(key as keyof typeof selectedDays)
                            }
